  ...
  if (!user) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <Link href="/auth/login" className="inline-flex items-center gap-2 rounded-full glass-btn px-6 py-3 text-sm font-semibold mt-4">
          Sign In
        </Link>
      </div>
    );
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 py-8 relative">
      ...
      <div className="flex items-start gap-4 mb-10">
        <Link href="/circles" className="inline-flex items-center gap-1.5 rounded-full glass-btn px-4 py-2.5 text-xs font-semibold mt-1 touch-target">
        ...
        {isMember && (
          isCreator ? (
            <button
              ...
              disabled={deleting}
              className="flex items-center gap-2 px-5 py-2.5 rounded-full glass-btn text-sm touch-target disabled:opacity-60"
            >
      ...
      <div className="mb-8 p-5 rounded-2xl border border-border bg-card/60 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={copyInviteLink} className="flex items-center gap-2 px-5 py-2.5 rounded-full glass-btn text-sm font-semibold touch-target">
      ...
      {isInvited && (
        <div className="mb-8 p-6 rounded-2xl border border-primary/30 bg-primary/5 backdrop-blur-xl text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            <button onClick={() => handleInviteResponse('accept')} className="inline-flex items-center gap-2 rounded-full glass-btn px-6 py-3 text-sm font-semibold touch-target">
              <UserCheck className="h-4 w-4" /> Accept Invite
            </button>
            <button onClick={() => handleInviteResponse('reject')} className="inline-flex items-center gap-2 rounded-full glass-btn px-6 py-3 text-sm transition-all touch-target">
