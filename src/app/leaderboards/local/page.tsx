...
export default function LocalLeaderboardPage() {
  ...
  if (!latitude) {
    return (
      <div className="max-w-2xl mx-auto text-center py-20 text-gray-500">
        <MapPin className="h-12 w-12 text-pink-300 mx-auto mb-4" />
        <h2 className="text-lg font-semibold text-gray-700 dark:text-gray-300">Location Required</h2>
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Local Leaderboard</h1>
      </div>
