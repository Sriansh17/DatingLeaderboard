          ...
          <button
            ...
            className={cn(
              ...
              isSelected 
                ...
                : "border-transparent bg-black/20 hover:bg-white/10 hover:border-white/20 active:bg-white/15 active:border-white/30 opacity-80 hover:opacity-100 active:opacity-100"
            )}
          >
            <img
              src={url}
              ...
              className={cn(
                ...
                isSelected ? "scale-110 drop-shadow-2xl" : "group-hover:scale-110 group-focus-within:scale-110"
              )}
            />
            {isSelected && (
              <div className="absolute inset-0 bg-primary/10 flex items-center justify-center backdrop-blur-[1px] opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
