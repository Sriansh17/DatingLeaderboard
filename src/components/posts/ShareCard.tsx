...
export function ShareCard({ post, rank }: ShareCardProps) {
  ...
  return (
    <>
      ...
      <button
        onClick={handleShare}
        className="flex items-center justify-center gap-2 rounded-full bg-primary text-primary-foreground px-6 py-3 text-sm font-semibold shadow-[var(--shadow-glow)] hover:opacity-90 transition-all"
      >
