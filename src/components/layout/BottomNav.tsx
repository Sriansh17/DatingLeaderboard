...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-background/80 dark:bg-black/40 backdrop-blur-lg border-t border-border dark:border-white/10 md:hidden">
